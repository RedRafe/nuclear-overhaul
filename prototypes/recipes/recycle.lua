...
data:extend({
  ...
  -- Recycle used Plutonium MOX
  {
    ...
    results =
    {
      { name = 'uranium-237',   amount =  5 },
      { name = 'uranium-238',   amount = 88 },
      { name = 'plutonium-238', amount =  1 , probability = 0.45 },
      { name = 'plutonium-239', amount =  1 , probability = 0.55 },
    }
  },
  -- Recycle used LFTR MOX
  {
    ...
    results =
    {
      { name = 'neptunium-237', amount =  2 },
      { name = 'plutonium-238', amount = 18 },
    }
  }
})