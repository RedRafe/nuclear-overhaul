...
data:extend({
  -- U-235 to Pa-234
  {
    ...
    results =
    {
      { name = 'protactinium-234', probability = 0.98, amount = LF/2 },
      { name = 'uranium-235',      probability = 0.02, amount = 1 },
    }
  },
  -- Np-237 to Pa-233
  {
    ...
    results =
    {
      { name = 'protactinium-233', probability = 0.97, amount = LF/2 },
      { name = 'neptunium-237',    probability = 0.03, amount = 1 },
    }
  },
  -- Np-237 to U-236
  {
    ...
    results =
    {
      { name = 'uranium-236',   probability = 0.97, amount = LF/2 },
      { name = 'neptunium-237', probability = 0.03, amount = 1 },
    }
  },
  -- U-234 to Pa-233
  {
    ...
    results =
    {
      { name = 'protactinium-233', probability = 0.95, amount = LF/2 },
      { name = 'uranium-234',      probability = 0.05, amount = 1 },
    }
  },
  -- U-237 to Np-237
  {
    ...
    results =
    {
      { name = 'neptunium-237', probability = 0.95, amount = LF/2 },
      { name = 'uranium-237',   probability = 0.05, amount = 1 },
    }
  },
  -- Pa-234 to U-234
  {
    ...
    results =
    {
      { name = 'uranium-234',      probability = 0.95, amount = LF/2 },
      { name = 'protactinium-234', probability = 0.05, amount = 1 },
    }
  },
  -- Th-233 to Pa-233
  {
    ...
    results =
    {
      { name = 'protactinium-233', probability = 0.98, amount = LF/2 },
      { name = 'thorium-233',      probability = 0.02, amount = 1 },
    }
  },
  -- Pa-233 to U-233
  {
    ...
    results =
    {
      { name = 'uranium-233',      probability = 0.96, amount = LF/2 },
      { name = 'protactinium-233', probability = 0.04, amount = 1 },
    }
  }
})
